...
class Com extends Component {
      constructor (props) {
        ...
        this.state= {
          ...
          denglu:'账号登录',
          username:'',
          img: "//pic.ibaotu.com/head/default.png"
        }
      }
   componentDidMount () {
     if(localStorage.getItem('isLogin') ==='ok'){
      ...
      this.setState({
        img:"//qzapp.qlogo.cn/qzapp/101334430/56C47020FBC29E61CF35BF1ABBB7817D/100",
        denglu:'退出登录',
        username:name
      })
     }
         ...
         <div className = "content">
          <div className = "user-t">
            ...
            <div className = "user-t-r-t">
              <span>ID:{this.state.username}</span>
              <p></p>
            </div>
          ...
          <ul className="center-b">
            <li>
              ...
              <div className = "lis">
                <Link to="/userapp/shoucang">我的收藏</Link>
                <img src="//js.ibaotu.com/mobile/img/icons/user/icon-backs.png" alt=""/>
              </div>
            </li>
            <li>
